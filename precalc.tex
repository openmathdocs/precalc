...
\makeatletter
\if@tempswa % draft option is active
    % make the specialnote environment without colour, no frame
    \newtheorem{specialnote}{}% formerly known as pccspecialcomment
\else%
...
%====================================
\newenvironment{checkpoint}% formerly doyouunderstand
...
%====================================
%   END essentialskills, checkpoint, exercises
%====================================
...
{%
      ...
      \Writetofile{shortsolutions}{\protect\stepcounter{section}\protect\subsection*{Short answers for exercises in Section \protect\thesection}}%
      \thispagestyle{plain}%
