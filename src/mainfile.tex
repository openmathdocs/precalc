...
\usepackage{xfrac}				  									% \sfrac{a}{b}
\usepackage{siunitx}														% \si{\meter\per\second}, \SI{1}{\kilo\gram}, much more
	\sisetup{quotient-mode = fraction,per-mode=fraction,fraction-function = \sfrac}
...
\usepackage{pdfpages}
\usepackage{stackengine}    % vertical alignment of captions in subfigures
\usepackage{newfloat}       % to set options for figures, tables, globally
...
\SetupFloatingEnvironment{figure}{fileext=lof,placement={!htb},name=Figure}

% Table environment setup so that it no longer floats
\SetupFloatingEnvironment{table}{fileext=lot,placement={!htb},name=Table}
...
\newtheorem{omdexample}{Example}%[chapter]
...
\theorempostwork{}
\theoremseparator{}
\newtheorem{omdsolution}{Solution}
...
\if@tempswa % draft option is active
    ...
    \newtheorem{omddefinition}{Definition}%
\else%
    \newmdtheoremenv[outerlinewidth=3,
    ...
    skipabove=\baselineskip,ntheorem]{omddefinition}{Definition}%[chapter]
\fi
\makeatother
%====================================
...
%\include{chapters/exponentialfunctions}
%\include{chapter-functions-part-1}
\include{chapter-exponential-functions}
%\include{chapters/functions2}
%\include{chapters/logarithms}
%\include{chapters/polyrat}
%\include{ideas}
